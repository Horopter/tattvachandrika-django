...
MONGOENGINE_USER = os.getenv('PROD_MONGOENGINE_USER')
MONGOENGINE_PASSWORD = os.getenv('PROD_MONGOENGINE_PASSWORD')
MONGOENGINE_DATABASE_NAME = os.getenv('PROD_MONGOENGINE_DATABASE_NAME')
MONGOENGINE_HOST = os.getenv('PROD_MONGOENGINE_HOST')
MONGOENGINE_APP_NAME = os.getenv('APP_NAME')

# Updated connection string with tls=true for MongoDB Atlas
MONGOENGINE_CONNECTION_STRING = (
    f"mongodb://{MONGOENGINE_USER}:{MONGOENGINE_PASSWORD}@{MONGOENGINE_HOST}/"
    f"{MONGOENGINE_DATABASE_NAME}?retryWrites=true&w=majority&tls=true&appName={MONGOENGINE_APP_NAME}"
)
